...
- **Frontend-Unit-Tests:** Beim Einrichten der CI fehlten `test`-Target und Specs. Mit EN-2 (#93) sind Vitest und das Target ergänzt, der Job `frontend` führt jetzt `npm test -- --watch=false` aus.
